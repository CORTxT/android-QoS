...
//		}
	...
	public static boolean isEventPermitted (Context context, EventType eventType, int trigger)
	{
		if (eventType == EventType.SMS_TEST) {
			...
			//if (permissionValue != 0 && trigger > 0)
			//	return false;
		}
		return true;
	}
	...
	public final class Miscellaneous {
		...
		public static final String DONT_ASK_FOR_VQ_INSTRUCT_TRRS = "KEY_DONT_ASK_MAPPING_INSTRUCT_SAMPLE";
...
//        public static final String TRACKING_AUDIO_INTERVAL = "KEY_SETTINGS_TRACKING_AUDIO_INTERVAL";
		...
		public static final String AUTOSPEED_ENABLE_CHANGED = "KEY_SETTINGS_AUTOSPEED_ENABLE_CHANGED";
